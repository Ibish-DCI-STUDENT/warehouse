...
def search_and_order_item(item_name):
    ...
    if total_available == 0:
        ...
        max_warehouse = (
            "Warehouse 1" if count_warehouse1 > count_warehouse2 else "Warehouse 2"
        )
        print(
            f"Maximum availability: {max(count_warehouse1, count_warehouse2)} in {max_warehouse}"
        )
    ...
    if order_choice == "y":
        ...
        if desired_amount <= total_available:
            ...
            max_order_choice = (
                input("Would you like to order the maximum available? (y/n): ")
                .strip()
                .lower()
            )
...
while True:
    ...
    if choice == "1":
        ...
        print("**************************************************")
        print(
            "Invalid operation entered. Please choose a valid operation (1, 2, or 3)."
        )
        print("**************************************************")
